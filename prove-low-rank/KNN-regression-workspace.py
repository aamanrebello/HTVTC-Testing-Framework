...
class TestTensorCompletion_Cross(unittest.TestCase):
    ...
    def test_default_rank(self):
        ...
        #Cross sample tensor
        body, joints, arms, no_elements = cross_sample_tensor(tensor, tucker_rank_list=[2,2,4])
    ...
    def test_GP_regression(self):
        ...
        def transform_combination(combo_dict):
            if combo_dict['weightingFunction'] == 'uniform':
                combo_dict['weightingFunction'] = -1
            else:
                combo_dict['weightingFunction'] = 1
            combo_dict['distanceFunction'] = 0
