...
FILE_NAME = 'breast-cancer-indicator-100-1'
ARR_EXTN = '.npy'
...
class TestTensorCompletion_CP_WOPT_Dense(unittest.TestCase):
    ...
    def test_CP_WOPT_Dense_top10pc(self):
        #Apply tensor completion
        CP_WOPT_PREDICTED_TENSOR, _, _ = tensorcomplete_CP_WOPT_dense(incomplete_tensor, known_indices, CPD_rank, stepsize=0.01, iteration_limit=10000)
        #Check norm difference from true tensor
